...
from .views import post_list, post_detail, post_new, post_edit, post_delete, post_comment, \
    comment_delete, comment_edit, tag_post, like_or_dislike, tag_add, draft_list, \
    published_draft, tag_delete, cat_post_list
...
urlpatterns = [
    ...
    path('like_or_dislike/<int:post_pk>/<str:is_like>/<str:point>/', like_or_dislike, name='like_or_dislike'),
